        ...
        <body>
            ...
            <main>
                <div class="area">
                        ...
                        <c:forEach items="${carrinho}" var="carrinho">
                            <div class="carrinho">
                                ...
                                <form action="apagarProduto" method="post">
                                    ...
                                    <div class="excluir"><button name="apagarP" style="border: none;" type="submit"><i
                    ...
                    <br><br><br><br><br>
                    <form action="excluirCarrin" method="post"><button class="excluirCarrinh" type="submit">Excluir
            ...
            <script>
                var carrinhoItems = document.querySelectorAll('.carrinho');//seleciona a area onde estara os produtos
                if (carrinhoItems.length === 0) {//se estiver vazio fazera uma mensgem de campo vazio
